...
fig = plt.figure(figsize=(7.5,5) , dpi=100)
plt.plot(sw_vG(h,1),kr_vG(h,1),'-',color='k',alpha=0.2,label=r'$\gamma=1$')
plt.plot(sw_vG(h,2),kr_vG(h,2),'-',color='k',alpha=0.4,label=r'$\gamma=2$')
plt.plot(sw_vG(h,10),kr_vG(h,10),'-',color='k',alpha=0.6,label=r'$\gamma=10$')
plt.plot(sw_vG(h,50),kr_vG(h,50),'-',color='k',alpha=0.8,label=r'$\gamma=50$')
plt.plot(sw_vG(h,100),kr_vG(h,100),'-',color='k',alpha=1.0,label=r'$\gamma=100$')
manager = plt.get_current_fig_manager()
manager.window.showMaximized()
plt.ylabel(r'$k_r(h)$')
plt.xlim([s_r,s_s])
